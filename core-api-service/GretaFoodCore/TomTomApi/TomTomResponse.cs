...
namespace GretaFoodCore.Api.TomTomApi
{
    ...
    public partial class Result
    {
        ...
        [JsonProperty("dist")] public decimal Dist { get; set; }

        [JsonProperty("info")] public string Info { get; set; }

        [JsonProperty("poi")] public Poi Poi { get; set; }

        [JsonProperty("position")] public GeoBias Position { get; set; }
    ...
    public partial class Summary
    {
        ...
        [JsonProperty("queryType")] public string QueryType { get; set; }

        [JsonProperty("queryTime")] public long QueryTime { get; set; }

        [JsonProperty("numResults")] public long NumResults { get; set; }

        [JsonProperty("offset")] public long Offset { get; set; }

        [JsonProperty("totalResults")] public long TotalResults { get; set; }

        [JsonProperty("fuzzyLevel")] public long FuzzyLevel { get; set; }

        [JsonProperty("geoBias")] public GeoBias GeoBias { get; set; }
    }
